...
def fetch_youtube_urls(page_url):
    ...
    service = webdriver.ChromeService()  # Adjust the path to your chromedriver
...
if __name__ == "__main__":
    youtube_page_url = 'https://www.youtube.com/@penguinz0'  # Replace with the actual channel or playlist URL
